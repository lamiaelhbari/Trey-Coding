/* The assignment at Trey Corp is to update some of the legacy code.
1- Static Code Analysis : Run eslint . on the terminal.
2- Run eslint --fix . to automatically fix most of the issues found. 
3- Strict Mode : Run npm start to see which errors have been triggered. in strict mode and fix them.
4- Fixing file system vulnerability in the main menu
5- Fixing vulnerabilities in the Calculator
6- Fixing vulnerabilities in the Linux Emulator 
7- Fixing vulnerabilities in the Contact Form
*/ 
